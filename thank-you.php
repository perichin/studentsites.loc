...
<?php include( 'inc/header.php'); ?>
    <div class="container">
        ...
        <div class="row">
            <div id="thank-you" class="privacy-terms col-md-8 col-md-offset-2">
                ...
                <h1>Thank You - You have been prequalified!</h1>
                ...
                <p id="thank-you-big">
                    ...
                    If you cannot answer this call now please call us back later to learn about the programs available for you.<br /><br /><a href="http://awesomestudentloans.com" target="_blank">&#8594 Click To See Student Loan Options Online Now.</a>
                </p>
    ...
    <script type="text/javascript">
        setTimeout(function(){
            window.location = "http://awesomestudentloans.com";
        }, 10000);
    </script>
